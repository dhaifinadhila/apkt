  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi Paska Perbaikan </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
     ...
     <tr>
      	...
      	<form action="rekap_paska_perbaikan.php" method="post" enctype="multipart/form-data">	
			<tr>
	        <th height="19" scope="col">&nbsp;</th>
	        <th class="_css_font_default_11" scope="col">
				<div align="left">
		...
		<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
                    	<th>NO</th>
                         <!-- <th><div align='center'>ID PELANGGAN</div></th>-->
							...
							<th><div align='center'>TEGANGAN MASIH DROP</div></th>
							<th><div align='center'>BUKAN PETUGAS YANTEK PLN YG DATANG</div></th>
							<th><div align='center'>PEMINDAHAN PHASE OLEH BUKAN PETUGAS YANTEK PLN</div></th>
							<th><div align='center'>PERBAIKAN DILUAR JAM TUGAS PETUGAS</div></th>
							<th><div align='center'>PELANGGAN KEBERATAN DISAMBUNG LANGUNG OLEH PETUGAS</div></th>
							<th><div align='center'>SETELAH DIPERBAIKI TIDAK DISEGEL</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					} else 
					{
						...
						$rekap_paska_perbaikan = apkt_master_call_by_rekap_paska_perbaikan($BLN_THN);
					}

					$nomor=1;
					for ($i=0;$i<count($rekap_paska_perbaikan);$i++) {
						$VAR_KODE_AREA	= $rekap_paska_perbaikan[$i]['KODE_AREA'];
						$VAR_NAMA_AREA	= $rekap_paska_perbaikan[$i]['NAMA_AREA'];
						$VAR_JAWABAN_1 	= $rekap_paska_perbaikan[$i]['TEGANGAN_MSH_DROP'];
						$VAR_JAWABAN_2 	= $rekap_paska_perbaikan[$i]['BUKAN_PETUGAS_YANTEK_PLN'];
						$VAR_JAWABAN_3 	= $rekap_paska_perbaikan[$i]['PINDAH_PHASE'];
						$VAR_JAWABAN_4 	= $rekap_paska_perbaikan[$i]['PERBAIKAN_INSTALASI'];
						$VAR_JAWABAN_5	= $rekap_paska_perbaikan[$i]['PELANGGAN_KEBERATAN'];
						$VAR_JAWABAN_6 	= $rekap_paska_perbaikan[$i]['TDK_DISEGEL_KEMBALI'];
						$VAR_JAWABAN_7 	= $rekap_paska_perbaikan[$i]['NORMAL'];
						$VAR_JAWABAN_KOSONG		= $rekap_paska_perbaikan[$i]['JAWABAN_KOSONG'];
						$VAR_TOTAL_PELANGGAN 	= $rekap_paska_perbaikan[$i]['TOTAL_PELANGGAN'];
						...
						echo "<tr>";
							...
							echo "<td><div align='center'>".strtoupper($VAR_JAWABAN_6)."</div></td>";
							echo "<td><div align='center'>".strtoupper($VAR_JAWABAN_7)."</div></td>";
