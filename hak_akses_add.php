      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><form action="hak_akses_add_submit.php" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="_css_font_default_12"><div align="left"><strong>ID Hak Akses</strong> </div></td>
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="ID_HAK_AKSES" type="text" class="_css_input_text" id="ID_HAK_AKSES"></td>
              <td>
            <tr>
              <td>&nbsp;</td>
              <td class="_css_font_default_12"><div align="left"><strong>Hak Akses</strong> </div></td>
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="HAK_AKSES" type="text" class="_css_input_text" id="HAK_AKSES"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
