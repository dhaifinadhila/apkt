...
$return_edit_master = apkt_master_update(
		$VAR_ID_MASTER, 
		$VAR_ID_PELANGGAN, 
		$VAR_NOMOR_LAPOR, 
		$VAR_NAMA, 
...
if ($return_edit_master==1) {
	echo '<script language="javascript">alert("Data Master Berhasil diupdate")</script>';
	echo '<script language="javascript">window.location = "master.php"</script>';
} else {
	echo '<script language="javascript">alert("Data Master Gagal diupdate")</script>';
	echo '<script language="javascript">window.location = "master.php"</script>';
}
?>
