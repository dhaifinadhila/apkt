...
$hak_akses = apkt_hak_akses_search_by_id_hak_akses($VAR_ID_HAK_AKSES);

$VAR_ID_HAK_AKSES = $hak_akses[0]['ID_HAK_AKSES'];
$VAR_HAK_AKSES = $hak_akses[0]['HAK_AKSES'];
      ...
      <tr>
		...
		<form action="hak_akses_edit_submit.php?id=<? echo $VAR_ID_HAK_AKSES; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <input name="ID_HAK_AKSES" type="hidden" id="ID_HAK_AKSES" value="<? echo $VAR_ID_HAK_AKSES; ?>">
            <tr>
              <td>&nbsp;</td>
              ...
              <td><input name="HAK_AKSES" type="text" class="_css_input_text" id="HAK_AKSES" value="<? echo $VAR_HAK_AKSES; ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
