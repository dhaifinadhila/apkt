  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi Pelanggan Belum Nyala </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
...
<tr>
      	...
      	<form action="rekap_pelanggan_blm_nyala.php" method="post" enctype="multipart/form-data">	
			<tr>
	        <th height="19" scope="col">&nbsp;</th>
	        <th class="_css_font_default_11" scope="col">
				<div align="left">
		...
		<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
                    	<th>NO</th>
                         <!-- <th><div align='center'>ID PELANGGAN</div></th>-->
							...
							<th><div align='center'>PELANGGAN BELUM NYALA</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					} else 
					{
						...
						$rekap_blm_nyala = apkt_master_call_by_rekap_pelanggan_blm_nyala($BLN_THN);
					}

					$nomor=1;
					for ($i=0;$i<count($rekap_blm_nyala);$i++) {
						$VAR_KODE_AREA	= $rekap_blm_nyala[$i]['KODE_AREA'];
						$VAR_NAMA_AREA	= $rekap_blm_nyala[$i]['NAMA_AREA'];
						$VAR_JAWABAN_1 = $rekap_blm_nyala[$i]['BLM_NYALA'];
