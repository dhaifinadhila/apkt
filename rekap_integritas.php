  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi Integritas </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      ...
      <tr>
      	...
      	<form action="rekap_integritas.php" method="post" enctype="multipart/form-data">	
			<tr>
	        <th height="19" scope="col">&nbsp;</th>
	        <th class="_css_font_default_11" scope="col">
				<div align="left">
		...
		<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
                    	<th>NO</th>
                         <!-- <th><div align='center'>ID PELANGGAN</div></th>-->
							...
							<th><div align='center'>UANG UNTUK TIPS</div></th>
							<th><div align='center'>UANG UNTUK MATERIAL</div></th>
							<th><div align='center'>TIPS BERUPA BARANG </div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					} else 
					{
						...
						$rekap_integritas = apkt_master_call_by_rekap_integritas($BLN_THN);
					}

					$nomor=1;
					for ($i=0;$i<count($rekap_integritas);$i++) {
						$VAR_KODE_AREA	= $rekap_integritas[$i]['KODE_AREA'];
						$VAR_NAMA_AREA	= $rekap_integritas[$i]['NAMA_AREA'];
						$VAR_JAWABAN_1 	= $rekap_integritas[$i]['TIDAK_BERI_APAPUN'];
						$VAR_JAWABAN_2 	= $rekap_integritas[$i]['UANG_TIPS'];
						$VAR_JAWABAN_3 	= $rekap_integritas[$i]['UANG_MATERIAL'];
						$VAR_JAWABAN_4 	= $rekap_integritas[$i]['TIPS_BARANG'];
						$VAR_JAWABAN_KOSONG		= $rekap_integritas[$i]['JAWABAN_KOSONG'];
						$VAR_TOTAL_PELANGGAN 	= $rekap_integritas[$i]['TOTAL_PELANGGAN'];
