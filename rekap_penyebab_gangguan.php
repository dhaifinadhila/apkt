  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi Penyebab Gangguan </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      	...
      	<form action="rekap_penyebab_gangguan.php" method="post" enctype="multipart/form-data">	
			<tr>
	        <th height="19" scope="col">&nbsp;</th>
	        <th class="_css_font_default_11" scope="col">
				<div align="left">
		...
		<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
                    	<th>NO</th>
                         <!-- <th><div align='center'>ID PELANGGAN</div></th>-->
							...
							<th><div align='center'>PENYEBAB GANGGUAN/PADAM</div></th>
							<th><div align='center'>PEMBERITAHUAN AKAN ADA PETUGAS YG MENGGANTIKAN PERALATAN</div></th>
							<th><div align='center'>PEMBERITAHUAN ADA TAGIHAN SUSULAN</div></th>
							<th><div align='center'>PETUGAS TIDAK MENINGGALKAN PESAN/INFORMASI</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					} else 
					{
						...
						$rekap_penyebab_gangguan = apkt_master_call_by_rekap_penyebab_gangguan($BLN_THN);
					}

					$nomor=1;
					for ($i=0;$i<count($rekap_penyebab_gangguan);$i++) {
						$VAR_KODE_AREA	= $rekap_penyebab_gangguan[$i]['KODE_AREA'];
						$VAR_NAMA_AREA	= $rekap_penyebab_gangguan[$i]['NAMA_AREA'];
						$VAR_JAWABAN_1 	= $rekap_penyebab_gangguan[$i]['PENYEBAB_GANGGUAN'];
						$VAR_JAWABAN_2 	= $rekap_penyebab_gangguan[$i]['SURAT_LG'];
						$VAR_JAWABAN_3 	= $rekap_penyebab_gangguan[$i]['TAGIHAN_SUSULAN'];
						$VAR_JAWABAN_4 	= $rekap_penyebab_gangguan[$i]['TDK_BERI_PESAN'];
						$VAR_JAWABAN_KOSONG		= $rekap_penyebab_gangguan[$i]['JAWABAN_KOSONG'];
						$VAR_TOTAL_PELANGGAN 	= $rekap_penyebab_gangguan[$i]['TOTAL_PELANGGAN'];
