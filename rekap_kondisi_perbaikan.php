  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi Kondisi Perbaikan </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      	...
      	<form action="rekap_kondisi_perbaikan.php" method="post" enctype="multipart/form-data">	
			<tr>
	        <th height="19" scope="col">&nbsp;</th>
	        <th class="_css_font_default_11" scope="col">
				<div align="left">
		...
		<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
                    	<th>NO</th>
                         <!-- <th><div align='center'>ID PELANGGAN</div></th>-->
							...
							<th><div align='center'>SAMBUNG NORMAL SEPERTI SEMULA</div></th>
							<th><div align='center'>SAMBUNG SEMENTARA VIA METER</div></th>
							<th><div align='center'>SAMBUNG LANGSUNG VIA PEMBATAS</div></th>
							<th><div align='center'>SAMBUNG LANGUNG TANPA METER DAN TANPA MCB</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					} else 
					{
						...
						$rekap_kondisi_perbaikan = apkt_master_call_by_rekap_kondisi_perbaikan($BLN_THN);
					}

					$nomor=1;
					for ($i=0;$i<count($rekap_kondisi_perbaikan);$i++) {
						$VAR_KODE_AREA	= $rekap_kondisi_perbaikan[$i]['KODE_AREA'];
						$VAR_NAMA_AREA	= $rekap_kondisi_perbaikan[$i]['NAMA_AREA'];
						$VAR_JAWABAN_1 	= $rekap_kondisi_perbaikan[$i]['NORMAL'];
						$VAR_JAWABAN_2 	= $rekap_kondisi_perbaikan[$i]['SEMENTARA'];
						$VAR_JAWABAN_3 	= $rekap_kondisi_perbaikan[$i]['LANGSUNG_VIA_PEMBATAS'];
						$VAR_JAWABAN_4 	= $rekap_kondisi_perbaikan[$i]['LANGSUNG'];
						$VAR_JAWABAN_KOSONG		= $rekap_kondisi_perbaikan[$i]['JAWABAN_KOSONG'];
						$VAR_TOTAL_PELANGGAN 	= $rekap_kondisi_perbaikan[$i]['TOTAL_PELANGGAN'];
