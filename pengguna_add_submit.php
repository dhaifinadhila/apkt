...
$return_add_pengguna = apkt_pengguna_insert($VAR_ID_USER,$VAR_KODE_AREA,$VAR_HAK_AKSES,$VAR_KODE_POSISI,$VAR_NIP,$VAR_NAMA,$VAR_EMAIL,$VAR_PASSWD,$VAR_JABATAN,$VAR_TARGET_CALL,
							$VAR_KETERANGAN,$VAR_INFORMASI_01,$VAR_INFORMASI_02,$VAR_INFORMASI_03,$VAR_INFORMASI_04,$VAR_INFORMASI_05);
