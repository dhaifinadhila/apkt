  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi Laporan Berulang CC 123 </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      ...
      <tr>
      	...
      	<form action="rekap_laporan_berulang.php" method="post" enctype="multipart/form-data">	
			<tr>
	        <th height="19" scope="col">&nbsp;</th>
	        <th class="_css_font_default_11" scope="col">
				<div align="left">
		...
		<table id="example" class="display" cellspacing="0" width="100%">
					...
					<tr>
                    	<th>NO</th>
                         <!-- <th><div align='center'>ID PELANGGAN</div></th>-->
							...
							<th><div align='center'>1 KALI</div></th>
							<th><div align='center'>2 KALI</div></th>
							<th><div align='center'>3 KALI ATAU LEBIH</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					} else 
					{
						...
						$rekap_laporan_berulang = apkt_master_call_by_rekap_laporan_berulang($BLN_THN);
					}

					$nomor=1;
					for ($i=0;$i<count($rekap_laporan_berulang);$i++) {
						$VAR_KODE_AREA	= $rekap_laporan_berulang[$i]['KODE_AREA'];
						$VAR_NAMA_AREA	= $rekap_laporan_berulang[$i]['NAMA_AREA'];
						$VAR_JAWABAN_1 	= $rekap_laporan_berulang[$i]['SATU_KALI'];
						$VAR_JAWABAN_2 	= $rekap_laporan_berulang[$i]['DUA_KALI'];
						$VAR_JAWABAN_3 	= $rekap_laporan_berulang[$i]['TIGA_KALI'];
						$VAR_JAWABAN_KOSONG		= $rekap_laporan_berulang[$i]['JAWABAN_KOSONG'];
						$VAR_TOTAL_PELANGGAN 	= $rekap_laporan_berulang[$i]['TOTAL_PELANGGAN'];
