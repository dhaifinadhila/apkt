  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
		...
		<form action="pengguna_edit_submit.php?id=<? echo $VAR_ID_USER; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            <tr>
              ...
              <td><input name="ID_USER" type="hidden" id="ID_USER" value="<? echo $VAR_ID_USER ?>"></td>
            <tr>
              <td>&nbsp;</td>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
                            <td><select name="KODE_AREA" class="_css_input_text">
          <?php
          $unit = apkt_area_view();
          $nomor=1;
          ...
          ?>
            ...
            <tr>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><select name="HAK_AKSES" class="_css_input_text" id="VAR_HAK_AKSES">
          <?php
          ...
          ?>                  
            ...
            <tr>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="NIP" type="text" class="_css_input_text" id="NIP" size="60" value="<? echo $VAR_NIP ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            ...
            <tr>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="EMAIL" type="text" class="_css_input_text" id="EMAIL" size="60" value="<? echo $VAR_EMAIL ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="PASSWD" type="password" class="_css_input_text" id="PASSWD" size="60" value="<? echo $VAR_PASSWD ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="JABATAN" type="text" class="_css_input_text" id="JABATAN" size="60" value="<? echo $VAR_JABATAN ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="TARGET_CALL" type="text" class="_css_input_text" id="TARGET_CALL" size="60" value="<? echo $VAR_TARGET_CALL ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
